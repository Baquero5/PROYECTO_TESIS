...
export default function Subcategorias() {
    ...
    const handleEdit = (sub) => {
        setFormData({
            id_categoria: sub.id_categoria.toString(),
            nombre: sub.nombre,
    ...
    const filtered = subcategorias.filter(s => {
        const matchSearch = s.nombre.toLowerCase().includes(search.toLowerCase()) ||
            (s.nombre_categoria || '').toLowerCase().includes(search.toLowerCase());
        const matchCategoria = !filterCategoria || s.id_categoria.toString() === filterCategoria;
